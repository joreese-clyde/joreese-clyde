...
### `$ cat about.txt`
Mabuhay! I'm **Joreese Clyde** — a full-stack developer based in the Philippines who enjoys building functional, easy-to-use software and picking up new tools along the way.

### `$ ./current_focus.sh`
- Sharpening dev skills & system design principles
- Growing repos with hands-on projects
- Open to freelance commissions & collab
- Learning backend architecture & clean code
